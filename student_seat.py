...
class Application(tkinter.Frame): #tkinterのフレームを継承
    ...
    def create_widgets(self):
        ...
        self.text_box=tkinter.Entry(self, width = 20)
        self.text_box.place(x=10,y=10,width=200,height=300)
    ...
    def save_data(self):
        ...
        self.message['text']='生徒番号'+text+'の席番号は '+str(seat_number.value)+' です。'
...
retsu_number = 3
#a = ("Arial black", 20, "bold")#最高・最低気温を表すフォント　フォント名、大きさ、太字
